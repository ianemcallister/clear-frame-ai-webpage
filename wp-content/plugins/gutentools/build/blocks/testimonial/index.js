...
/* harmony import */ var _styles_editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../styles/editor.scss */ "./src/blocks/testimonial/styles/editor.scss");
...
/* harmony import */ var _inspector__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./inspector */ "./src/blocks/testimonial/components/inspector.js");
...
function Edit(props) {
  ...
  if (imageBorder) {
    if (imageBorder.left) {
      imageBorderStyle.borderLeft = `${imageBorder.left.width || "initial"} ${imageBorder.left.style || "solid"} ${imageBorder.left.color || "white"}`;
    }
    if (imageBorder.right) {
      imageBorderStyle.borderRight = `${imageBorder.right.width || "initial"} ${imageBorder.right.style || "solid"} ${imageBorder.right.color || "white"}`;
    }
    if (imageBorder.top) {
      imageBorderStyle.borderTop = `${imageBorder.top.width || "initial"} ${imageBorder.top.style || "solid"} ${imageBorder.top.color || "white"}`;
    }
    if (imageBorder.bottom) {
      imageBorderStyle.borderBottom = `${imageBorder.bottom.width || "initial"} ${imageBorder.bottom.style || "solid"} ${imageBorder.bottom.color || "white"}`;
    }

    // Only set general border if no individual sides are defined
    if (!imageBorder.left && !imageBorder.right && !imageBorder.top && !imageBorder.bottom) {
      imageBorderStyle.border = `${imageBorder.width || "initial"} ${imageBorder.style || "solid"} ${imageBorder.color || "white"}`;
    }
  } else {
    imageBorderStyle.border = "none"; // Default to no border if `borders` is null or undefined
  }
  const boxBorderStyle = {};
  if (boxBorder) {
    if (boxBorder.left) {
      boxBorderStyle.borderLeft = `${boxBorder.left.width || "initial"} ${boxBorder.left.style || "solid"} ${boxBorder.left.color || "white"}`;
    }
    if (boxBorder.right) {
      boxBorderStyle.borderRight = `${boxBorder.right.width || "initial"} ${boxBorder.right.style || "solid"} ${boxBorder.right.color || "white"}`;
    }
    if (boxBorder.top) {
      boxBorderStyle.borderTop = `${boxBorder.top.width || "initial"} ${boxBorder.top.style || "solid"} ${boxBorder.top.color || "white"}`;
    }
    if (boxBorder.bottom) {
      boxBorderStyle.borderBottom = `${boxBorder.bottom.width || "initial"} ${boxBorder.bottom.style || "solid"} ${boxBorder.bottom.color || "white"}`;
    }

    // Only set general border if no individual sides are defined
    if (!boxBorder.left && !boxBorder.right && !boxBorder.top && !boxBorder.bottom) {
      boxBorderStyle.border = `${boxBorder.width || "initial"} ${boxBorder.style || "solid"} ${boxBorder.color || "white"}`;
    }
  } else {
    boxBorderStyle.border = "none"; // Default to no border if `borders` is null or undefined
  }
  const boxStyle = {
    backgroundColor: boxBackgroundColor,
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("padding", boxPadding),
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("margin", boxMargin),
    borderRadius: (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getResponsiveRangeVal)(boxBorderRadius),
    ...boxBorderStyle
  };
  const imageStyle = {
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("size", imageSize),
    ...imageBorderStyle,
    borderRadius: (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getResponsiveRangeVal)(imageBorderRadius),
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("padding", imagePadding),
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("margin", imageMargin)
  };
  const nameStyle = {
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getTypoStyle)(nameTypo),
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("padding", namePadding),
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("margin", nameMargin),
    color: nameColor
  };
  const positionStyle = {
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getTypoStyle)(positionTypo),
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("padding", positionPadding),
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("margin", positionMargin),
    color: positionColor
  };
  const textStyle = {
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getTypoStyle)(testimonialTextTypo),
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("padding", testimonialTextPadding),
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("margin", testimonialTextMargin),
    color: testimonialTextColor
  };
  const quoteIconStyle = {
    fontSize: (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getResponsiveRangeVal)(quoteIconSize),
    color: quoteIconColor
  };
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
    className: `${_constants__WEBPACK_IMPORTED_MODULE_6__.prefix}-testimonial-wrapper`
  });
  let img = (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getLocalImage)("default.png");
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    setAttributes({
      block_id: `${_constants__WEBPACK_IMPORTED_MODULE_6__.prefix}-testimonial-${blockProps.id}`
    });
  }, []);
  const Star_Style = [["gutentools/star-rating", {
    alignment: "center",
    rating: 4.5
  }]];
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inspector__WEBPACK_IMPORTED_MODULE_7__["default"], {
    ...
    className: `${_constants__WEBPACK_IMPORTED_MODULE_6__.prefix}-align-${alignment} gutentools-testimonial-content`
  }, showImage && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "gutentools-testimonial-image"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    src: image && image.url ? image.url : img,
    alt: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Testimonial Image", "gutentools"),
    style: imageStyle
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "gutentools-testimonial-content"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "gutentools-name-and-position"
  }, showName && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    tagName: "h3",
    value: name,
    allowedFormats: [],
    className: "gutentools-testimonial-name",
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("John Doe", "gutentools"),
    style: nameStyle,
    onChange: name => setAttributes({
      name
    })
  }), showPosition && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    tagName: "p",
    value: position,
    allowedFormats: [],
    className: "gutentools-testimonial-position",
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("CEO/XYZ Company", "gutentools"),
    style: positionStyle,
    onChange: position => setAttributes({
      position
    })
  })), showRating && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InnerBlocks, {
    allowedBlocks: ["gutentools/star-rating"],
    template: Star_Style,
    templateLock: "all"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "gutentools-testimonial-text-wrapper"
  }, showQuoteIcon && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
    class: "fa-solid fa-quote-left",
    style: quoteIconStyle
  }), showText && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    tagName: "p",
    value: testimonialText,
    allowedFormats: [],
    className: "gutentools-testimonial-text",
    style: textStyle,
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Donec elit libero sodales nec.....", "gutentools"),
    onChange: testimonialText => setAttributes({
      testimonialText
    })
  }), showQuoteIcon && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../block.json */ "./src/blocks/testimonial/block.json");
...
const InspectorPanel = props => {
  ...
  const def = (0,_helpers__WEBPACK_IMPORTED_MODULE_11__.getDefaultAttr)(_block_json__WEBPACK_IMPORTED_MODULE_10__);
  const general = () => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Show Image", "gutentools"),
    checked: showImage,
    onChange: showImage => setAttributes({
      showImage
    })
  }), showImage && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_image_control__WEBPACK_IMPORTED_MODULE_8__["default"], {
    onSelect: image => setAttributes({
      image
    }),
    value: image
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("br", null), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control__WEBPACK_IMPORTED_MODULE_4__.SwitchControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Show Name", "gutentools"),
    checked: showName,
    onChange: showName => setAttributes({
      showName
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control__WEBPACK_IMPORTED_MODULE_4__.SwitchControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Show Position", "gutentools"),
    checked: showPosition,
    onChange: showPosition => setAttributes({
      showPosition
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control__WEBPACK_IMPORTED_MODULE_4__.SwitchControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Show Text", "gutentools"),
    checked: showText,
    onChange: showText => setAttributes({
      showText
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control__WEBPACK_IMPORTED_MODULE_4__.SwitchControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Show Quote Icon", "gutentools"),
    checked: showQuoteIcon,
    onChange: showQuoteIcon => setAttributes({
      showQuoteIcon
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control__WEBPACK_IMPORTED_MODULE_4__.SwitchControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Show Rating", "gutentools"),
    checked: showRating,
    onChange: showRating => setAttributes({
      showRating
    })
  })));
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, {
    ...
    initialOpen: true
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control__WEBPACK_IMPORTED_MODULE_4__.BorderControl, {
    value: boxBorder,
    onChange: boxBorder => setAttributes({
      boxBorder
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_responsive_range_wrapper__WEBPACK_IMPORTED_MODULE_9__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Border Radius", "gutentools"),
    defaultValue: def("boxBorderRadius"),
    value: boxBorderRadius,
    onChange: boxBorderRadius => setAttributes({
      boxBorderRadius
    }),
    beforeIcon: ""
  }), showQuoteIcon && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_responsive_range_wrapper__WEBPACK_IMPORTED_MODULE_9__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Quote Icon Size", "gutentools"),
    defaultValue: def("quoteIconSize"),
    value: quoteIconSize,
    onChange: quoteIconSize => setAttributes({
      quoteIconSize
    }),
    beforeIcon: ""
    ...
    colorSettings: [{
      ...
      onChange: boxBackgroundColor => setAttributes({
        boxBackgroundColor: (0,_helpers__WEBPACK_IMPORTED_MODULE_11__.isUndefined)(boxBackgroundColor) ? "" : boxBackgroundColor
      })
    }, showName && {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Name Color", "gutentools"),
      value: nameColor,
      onChange: nameColor => setAttributes({
        nameColor: (0,_helpers__WEBPACK_IMPORTED_MODULE_11__.isUndefined)(nameColor) ? "" : nameColor
      })
    }, showPosition && {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Position Color", "gutentools"),
      value: positionColor,
      onChange: positionColor => setAttributes({
        positionColor: (0,_helpers__WEBPACK_IMPORTED_MODULE_11__.isUndefined)(positionColor) ? "" : positionColor
      })
    }, showText && {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Text Color", "gutentools"),
      value: testimonialTextColor,
      onChange: testimonialTextColor => setAttributes({
        testimonialTextColor: (0,_helpers__WEBPACK_IMPORTED_MODULE_11__.isUndefined)(testimonialTextColor) ? "" : testimonialTextColor
      })
    }, showQuoteIcon && {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Quote Icon Color", "gutentools"),
      value: quoteIconColor,
      onChange: quoteIconColor => setAttributes({
        quoteIconColor: (0,_helpers__WEBPACK_IMPORTED_MODULE_11__.isUndefined)(quoteIconColor) ? "" : quoteIconColor
      })
    }]
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Typography", "gutentools"),
    initialOpen: false
  }, showName && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_typography__WEBPACK_IMPORTED_MODULE_5__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Name", "gutentools"),
    value: nameTypo,
    defaultValue: _block_json__WEBPACK_IMPORTED_MODULE_10__.attributes.nameTypo["default"],
    onChange: nameTypo => setAttributes({
      nameTypo
    })
  }), showPosition && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_typography__WEBPACK_IMPORTED_MODULE_5__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Position", "gutentools"),
    value: positionTypo,
    defaultValue: _block_json__WEBPACK_IMPORTED_MODULE_10__.attributes.positionTypo["default"],
    onChange: positionTypo => setAttributes({
      positionTypo
    })
  }), showText && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_typography__WEBPACK_IMPORTED_MODULE_5__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Text", "gutentools"),
    value: testimonialTextTypo,
    defaultValue: _block_json__WEBPACK_IMPORTED_MODULE_10__.attributes.testimonialTextTypo["default"],
    onChange: testimonialTextTypo => setAttributes({
      testimonialTextTypo
    })
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Image", "gutentools"),
    initialOpen: false
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_dimension__WEBPACK_IMPORTED_MODULE_7__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Image Size", "gutentools"),
    defaultValue: def("imageSize"),
    value: imageSize,
    ...
    value: imageBorder,
    onChange: imageBorder => setAttributes({
      imageBorder
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_responsive_range_wrapper__WEBPACK_IMPORTED_MODULE_9__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Border Radius", "gutentools"),
    ...
    onChange: imageBorderRadius => setAttributes({
      imageBorderRadius
    }),
    beforeIcon: ""
    ...
    defaultValue: def("boxMargin"),
    value: boxMargin,
    onChange: boxMargin => setAttributes({
      boxMargin
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), showImage && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_dimension__WEBPACK_IMPORTED_MODULE_7__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Image Padding", "gutentools"),
    defaultValue: def("imagePadding"),
    value: imagePadding,
    onChange: imagePadding => setAttributes({
      imagePadding
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), showImage && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_dimension__WEBPACK_IMPORTED_MODULE_7__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Image Margin", "gutentools"),
    defaultValue: def("imageMargin"),
    value: imageMargin,
    onChange: imageMargin => setAttributes({
      imageMargin
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), showName && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_dimension__WEBPACK_IMPORTED_MODULE_7__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Name Padding", "gutentools"),
    defaultValue: def("namePadding"),
    value: namePadding,
    onChange: namePadding => setAttributes({
      namePadding
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), showName && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_dimension__WEBPACK_IMPORTED_MODULE_7__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Name Margin", "gutentools"),
    defaultValue: def("nameMargin"),
    value: nameMargin,
    onChange: nameMargin => setAttributes({
      nameMargin
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), showPosition && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_dimension__WEBPACK_IMPORTED_MODULE_7__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Position Padding", "gutentools"),
    defaultValue: def("positionPadding"),
    value: positionPadding,
    onChange: positionPadding => setAttributes({
      positionPadding
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), showPosition && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_dimension__WEBPACK_IMPORTED_MODULE_7__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Position Margin", "gutentools"),
    defaultValue: def("positionMargin"),
    value: positionMargin,
    onChange: positionMargin => setAttributes({
      positionMargin
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), showText && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_dimension__WEBPACK_IMPORTED_MODULE_7__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Text Padding", "gutentools"),
    defaultValue: def("testimonialTextPadding"),
    value: testimonialTextPadding,
    onChange: testimonialTextPadding => setAttributes({
      testimonialTextPadding
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), showText && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_dimension__WEBPACK_IMPORTED_MODULE_7__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Text Margin", "gutentools"),
    defaultValue: def("testimonialTextMargin"),
    value: testimonialTextMargin,
    onChange: testimonialTextMargin => setAttributes({
      testimonialTextMargin
    })
  })))))));
};
...
/* harmony import */ var _styles_style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./styles/style.scss */ "./src/blocks/testimonial/styles/style.scss");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  icon: _helpers_svg__WEBPACK_IMPORTED_MODULE_6__["default"].testimonial,
  save: props => {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"gutentools/testimonial","version":"1.0.0","title":"Testimonial","category":"gutentools","description":"Display customer feedback beautifully with the Testimonials Block. Customize quotes, client names, photos, and ratings to build trust and highlight success stories.","keywords":["review","testimonial"],"example":{},"supports":{"html":false},"attributes":{"block_id":{"type":"string"},"alignment":{"type":"string","default":"center"},"boxBackgroundColor":{"type":"string","default":"#f2f2f2"},"boxBorder":{"type":"object","default":{"color":"","style":"","width":"0"}},"boxBorderRadius":{"type":"object","default":{"activeUnit":"px","responsiveViews":["desktop","tablet","mobile"],"units":["px","em"],"range":{"min":0,"max":100},"values":{"desktop":5,"tablet":5,"mobile":5}}},"boxPadding":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[15,15,15,15],"tablet":[15,15,15,15],"mobile":[15,15,15,15]}}},"boxMargin":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[0,0,0,0],"tablet":[0,0,0,0],"mobile":[0,0,0,0]}}},"showImage":{"type":"boolean","default":true},"image":{"type":"object"},"imageSize":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["height","width"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem","%"],"values":{"desktop":[100,100],"tablet":[100,100],"mobile":[100,100]}}},"imageBorder":{"type":"object","default":{"color":"","style":"","width":"0"}},"imageBorderRadius":{"type":"object","default":{"activeUnit":"px","responsiveViews":["desktop","tablet","mobile"],"units":["px","em"],"range":{"min":0,"max":100},"values":{"desktop":100,"tablet":100,"mobile":100}}},"imagePadding":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[0,0,0,0],"tablet":[0,0,0,0],"mobile":[0,0,0,0]}}},"imageMargin":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[0,0,0,0],"tablet":[0,0,0,0],"mobile":[0,0,0,0]}}},"name":{"type":"string","default":"John Doe"},"showName":{"type":"boolean","default":true},"nameColor":{"type":"string","default":"#000"},"nameTypo":{"type":"object","default":{"fontFamily":"","fontSize":{"units":["px","em","rem"],"activeUnit":"px","values":{"desktop":24,"tablet":24,"mobile":24}},"fontWeight":600,"lineHeight":{"activeUnit":"","units":[""],"values":{"desktop":1,"tablet":1,"mobile":1}}}},"namePadding":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[0,0,0,0],"tablet":[0,0,0,0],"mobile":[0,0,0,0]}}},"nameMargin":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[15,0,15,0],"tablet":[15,0,15,0],"mobile":[15,0,15,0]}}},"position":{"type":"string","default":"CEO/XYZ Company"},"showPosition":{"type":"boolean","default":true},"positionColor":{"type":"string","default":"#777777"},"positionTypo":{"type":"object","default":{"fontFamily":"","fontSize":{"units":["px","em","rem"],"activeUnit":"px","values":{"desktop":16,"tablet":16,"mobile":16}},"fontWeight":400,"lineHeight":{"activeUnit":"","units":[""],"values":{"desktop":1,"tablet":1,"mobile":1}}}},"positionPadding":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[0,0,0,0],"tablet":[0,0,0,0],"mobile":[0,0,0,0]}}},"positionMargin":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[0,0,15,0],"tablet":[0,0,15,0],"mobile":[0,0,15,0]}}},"testimonialText":{"type":"string","default":"Fusce commodo aliquam arcu. Praesent congue erat at massa. Sed augue ipsum, egestas nec, vestibulum et, malesuada adipiscing, dui. Fusce pharetra convallis urna."},"showText":{"type":"boolean","default":true},"testimonialTextColor":{"type":"string","default":"#000"},"testimonialTextTypo":{"type":"object","default":{"fontFamily":"","fontSize":{"units":["px","em","rem"],"activeUnit":"px","values":{"desktop":16,"tablet":16,"mobile":16}},"fontWeight":400,"lineHeight":{"activeUnit":"","units":[""],"values":{"desktop":1.6,"tablet":1.6,"mobile":1.6}}}},"testimonialTextPadding":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[0,20,0,20],"tablet":[0,20,0,20],"mobile":[0,20,0,20]}}},"testimonialTextMargin":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[15,0,0,0],"tablet":[15,0,0,0],"mobile":[15,0,0,0]}}},"showQuoteIcon":{"type":"boolean","default":true},"quoteIconColor":{"type":"string","default":"#D7D7D7"},"quoteIconSize":{"type":"object","default":{"activeUnit":"px","responsiveViews":["desktop","tablet","mobile"],"units":["px","em"],"range":{"min":0,"max":100},"values":{"desktop":18,"tablet":18,"mobile":18}}},"showRating":{"type":"boolean","default":true}},"textdomain":"gutentools","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
