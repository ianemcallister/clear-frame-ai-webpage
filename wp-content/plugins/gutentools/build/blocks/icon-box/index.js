...
/* harmony import */ var _styles_editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../styles/editor.scss */ "./src/blocks/icon-box/styles/editor.scss");
...
/* harmony import */ var _inspector__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./inspector */ "./src/blocks/icon-box/components/inspector.js");
...
function Edit(props) {
  ...
  const iconBoxBorderStyle = {};
  if (iconBoxBorder) {
    if (iconBoxBorder.left) {
      iconBoxBorderStyle.borderLeft = `${iconBoxBorder.left.width || "initial"} ${iconBoxBorder.left.style || "solid"} ${iconBoxBorder.left.color || "white"}`;
    }
    if (iconBoxBorder.right) {
      iconBoxBorderStyle.borderRight = `${iconBoxBorder.right.width || "initial"} ${iconBoxBorder.right.style || "solid"} ${iconBoxBorder.right.color || "white"}`;
    }
    if (iconBoxBorder.top) {
      iconBoxBorderStyle.borderTop = `${iconBoxBorder.top.width || "initial"} ${iconBoxBorder.top.style || "solid"} ${iconBoxBorder.top.color || "white"}`;
    }
    if (iconBoxBorder.bottom) {
      iconBoxBorderStyle.borderBottom = `${iconBoxBorder.bottom.width || "initial"} ${iconBoxBorder.bottom.style || "solid"} ${iconBoxBorder.bottom.color || "white"}`;
    }

    // Only set general border if no individual sides are defined
    if (!iconBoxBorder.left && !iconBoxBorder.right && !iconBoxBorder.top && !iconBoxBorder.bottom) {
      iconBoxBorderStyle.border = `${iconBoxBorder.width || "initial"} ${iconBoxBorder.style || "solid"} ${iconBoxBorder.color || "white"}`;
    }
  } else {
    iconBoxBorderStyle.border = "none"; // Default to no border if `borders` is null or undefined
  }
  const iconBoxStyle = {
    backgroundColor: iconBoxBgColor,
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("padding", iconBoxPadding),
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("margin", iconBoxMargin),
    borderRadius: (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getResponsiveRangeVal)(iconBoxRadius),
    ...iconBoxBorderStyle
  };
  const iconStyle = {
  ...
  const titleStyle = {
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getTypoStyle)(titleTypo),
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("padding", titlePadding),
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getDimensionStyle)("margin", titleMargin),
    color: titleColor
  };
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
    className: `${_constants__WEBPACK_IMPORTED_MODULE_6__.prefix}-icon-box-wrapper`
  });
  let img = (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.getLocalImage)("default.png");
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    setAttributes({
      block_id: `${_constants__WEBPACK_IMPORTED_MODULE_6__.prefix}-icon-box-${blockProps.id}`
    });
  }, []);
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inspector__WEBPACK_IMPORTED_MODULE_7__["default"], {
    ...
    className: `${_constants__WEBPACK_IMPORTED_MODULE_6__.prefix}-align-${alignment} gutentools-icon-box-content`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "gutentools-icon-box-icon",
    style: iconStyle
    ...
    class: "icon-box-title-description"
    ...
    value: titleText,
    allowedFormats: [],
    className: "gutentools-icon-box-title",
    ...
    allowedFormats: [],
    className: "gutentools-icon-box-description",
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../block.json */ "./src/blocks/icon-box/block.json");
...
const InspectorPanel = props => {
  ...
  const general = () => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Show Title", "gutentools"),
    checked: showTitle,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, {
    ...
    value: iconBoxBorder,
    onChange: iconBoxBorder => setAttributes({
      iconBoxBorder
    })
    ...
    defaultValue: def("iconBoxRadius"),
    value: iconBoxRadius,
    onChange: iconBoxRadius => setAttributes({
      iconBoxRadius
    }),
    beforeIcon: ""
    ...
    colorSettings: [{
      ...
      onChange: iconBoxBgColor => setAttributes({
        iconBoxBgColor: (0,_helpers__WEBPACK_IMPORTED_MODULE_12__.isUndefined)(iconBoxBgColor) ? "" : iconBoxBgColor
      })
    }, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Title Color", "gutentools"),
      value: titleColor,
      ...
      onChange: descriptionColor => setAttributes({
        descriptionColor: (0,_helpers__WEBPACK_IMPORTED_MODULE_12__.isUndefined)(descriptionColor) ? "" : descriptionColor
      })
    }]
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Typography", "gutentools"),
    initialOpen: false
  }, showTitle && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_typography__WEBPACK_IMPORTED_MODULE_6__["default"], {
  ...
  }), showDescription && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_typography__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Box Padding", "gutentools"),
    defaultValue: def("iconBoxPadding"),
    value: iconBoxPadding,
    onChange: iconBoxPadding => setAttributes({
      iconBoxPadding
    })
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Box Margin", "gutentools"),
    defaultValue: def("iconBoxMargin"),
    value: iconBoxMargin,
    onChange: iconBoxMargin => setAttributes({
      iconBoxMargin
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), showTitle && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_dimension__WEBPACK_IMPORTED_MODULE_7__["default"], {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Title Margin", "gutentools"),
...
/* harmony import */ var _styles_style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles/style.scss */ "./src/blocks/icon-box/styles/style.scss");
/* harmony import */ var _components_edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/edit */ "./src/blocks/icon-box/components/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/blocks/icon-box/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_3__.name, {
  ...
  icon: _helpers_svg__WEBPACK_IMPORTED_MODULE_4__["default"].iconBox
});
...
/***/ "./src/blocks/icon-box/styles/editor.scss":
/*!************************************************!*\
  !*** ./src/blocks/icon-box/styles/editor.scss ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/icon-box/styles/style.scss":
/*!***********************************************!*\
  !*** ./src/blocks/icon-box/styles/style.scss ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"gutentools/icon-box","version":"1.0.0","title":"Icon Box","category":"gutentools","description":"This block offers a powerful and versatile way to create dynamic, customizable icon boxes with minimal effort. ","keywords":["icon","group","box"],"example":{},"supports":{"html":false},"attributes":{"titleTag":{"type":"number","default":"2"},"block_id":{"type":"string"},"alignment":{"type":"string","default":"left"},"iconBoxBgColor":{"type":"string","default":"#efefef"},"iconSize":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["height","width"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[40,40],"tablet":[30,30],"mobile":[30,30]}}},"iconFontSize":{"type":"object","default":{"activeUnit":"px","responsiveViews":["desktop","tablet","mobile"],"units":["px","em"],"range":{"min":0,"max":100},"values":{"desktop":21,"tablet":21,"mobile":21}}},"iconRadius":{"type":"object","default":{"activeUnit":"px","responsiveViews":["desktop","tablet","mobile"],"units":["px","em"],"range":{"min":0,"max":100},"values":{"desktop":5,"tablet":5,"mobile":5}}},"iconBoxPadding":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[15,15,15,15],"tablet":[15,15,15,15],"mobile":[15,15,15,15]}}},"iconBoxMargin":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[15,0,0,0],"tablet":[15,0,0,0],"mobile":[15,0,0,0]}}},"iconBorder":{"type":"object","default":{"color":"","style":"","width":"0"}},"iconBoxBorder":{"type":"object","default":{"color":"","style":"","width":"0"}},"iconBoxRadius":{"type":"object","default":{"activeUnit":"px","responsiveViews":["desktop","tablet","mobile"],"units":["px","em"],"range":{"min":0,"max":100},"values":{"desktop":5,"tablet":5,"mobile":5}}},"iconColor":{"type":"string","default":"#000"},"iconBgColor":{"type":"string","default":"#fcfcfc"},"titleText":{"type":"string","default":"Icon box title"},"titleTypo":{"type":"object","default":{"fontFamily":"","fontSize":{"units":["px","em","rem"],"activeUnit":"px","values":{"desktop":24,"tablet":24,"mobile":24}},"fontWeight":600,"lineHeight":{"activeUnit":"","units":[""],"values":{"desktop":1,"tablet":1,"mobile":1}}}},"titlePadding":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[0,0,0,0],"tablet":[0,0,0,0],"mobile":[0,0,0,0]}}},"titleMargin":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[15,0,0,0],"tablet":[15,0,0,0],"mobile":[15,0,0,0]}}},"titleColor":{"type":"string","default":"#000"},"showTitle":{"type":"boolean","default":true},"isImgIcon":{"type":"boolean","default":false},"showIcon":{"type":"boolean","default":true},"showDescription":{"type":"boolean","default":true},"descriptionText":{"type":"string","default":"Nam commodo suscipit quam. Donec mi odio, faucibus at, scelerisque quis, convallis in, nisi."},"descriptionColor":{"type":"string","default":"#000"},"descriptionTypo":{"type":"object","default":{"fontFamily":"","fontSize":{"units":["px","em","rem"],"activeUnit":"px","values":{"desktop":16,"tablet":16,"mobile":16}},"fontWeight":400,"lineHeight":{"activeUnit":"","units":[""],"values":{"desktop":1.6,"tablet":1.6,"mobile":1.6}}}},"descriptionPadding":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[0,0,0,0],"tablet":[0,0,0,0],"mobile":[0,0,0,0]}}},"descriptionMargin":{"type":"object","default":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[15,0,0,0],"tablet":[15,0,0,0],"mobile":[15,0,0,0]}}},"icon":{"type":"object","default":{"icon":"fa-cog"}},"iconImg":{"type":"object"}},"textdomain":"gutentools","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
